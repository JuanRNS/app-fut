  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-background">
      ...
      <main className="z-10 flex flex-col items-center text-center max-w-3xl space-y-8">
        <div className="w-24 h-24 bg-gradient-to-tr from-primary to-secondary rounded-full flex items-center justify-center shadow-2xl shadow-primary/20 mb-4">
          <span className="text-4xl">⚽</span>
        </div>

        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-foreground mb-4 drop-shadow-md">
      ...
      <footer className="absolute bottom-6 text-foreground/40 text-sm">
